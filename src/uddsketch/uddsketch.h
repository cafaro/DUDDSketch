...
class UDDSketch {
    public:
        ...
        void mergeAndMean(UDDSketch& other);
        void sketch_restore_from_p2p_average(double p_estimate);
        std::map<long, double> get_store_snap();
        void sketch_info();
    private:
